...
---@param starts string
---@return boolean
function string.starts_with(str, starts) return str:sub(1, #starts) == starts end -- luacheck: ignore
...
---@param ends string
---@return boolean
function string.ends_with(str, ends) return ends == "" or str:sub(-#ends) == ends end -- luacheck: ignore
...
---@param str string
---@return string
function string.strip_quotes(str) -- luacheck: ignore
