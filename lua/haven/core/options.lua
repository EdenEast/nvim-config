...
opt.signcolumn = "yes" -- always show sign column. currently there is a visual desync when this is auto. (#14195)
...
opt.shortmess:append({
  ...
  I = true, -- no spash screen
  O = true, -- file-read message overrites previous
  T = true, -- truncate non-file messages in middle
  W = true, -- dont echo '[w]/[written]' when writing
  a = true, -- use abbreviations in message '[ro]' instead of '[readonly]'
  o = true, -- overwrite file-written mesage
  t = true, -- truncate file messages at start
  c = true, -- dont show matching messages
})
